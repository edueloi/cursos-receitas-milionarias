    ...
    <header className="h-16 sm:h-[68px] fixed top-0 right-0 left-0 z-40 px-3 sm:px-5 lg:px-8 transition-all duration-300 bg-white/95 backdrop-blur-xl border-b border-gray-100/80 shadow-[0_1px_3px_rgba(0,0,0,0.04)] flex items-center justify-between">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3 shrink-0">
        ...
        <div className="relative" ref={notificationsRef}>
          ...
          {isNotificationsOpen && (
            <div className="fixed left-4 right-4 top-[68px] sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-2 sm:w-96 bg-white rounded-2xl shadow-2xl border border-gray-100 animate-fade-in origin-top-right z-50 ring-1 ring-black/5 max-h-[75vh] flex flex-col">
              {/* Notification Header */}
